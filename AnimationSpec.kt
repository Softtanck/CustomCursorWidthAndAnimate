...
//----------------------
fun <T> hookedInfiniteRepeatable(
    animation: DurationBasedAnimationSpec<T>,
    repeatMode: RepeatMode = RepeatMode.Restart,
    initialStartOffset: StartOffset = StartOffset(0)
): InfiniteRepeatableSpec<T> {
//    val innerAnimation = keyframes {
//        durationMillis = 1000
//        1f at 0
//        0.9f at 99
//        0.8f at 199
...
//        0f at 999
//    }
    val innerAnimation = TweenSpec<Float>(1000, easing = LinearEasing)
    Log.d("~~~", "infiniteRepeatable ->: $animation")
    return infiniteRepeatable(innerAnimation, RepeatMode.Reverse, initialStartOffset) as InfiniteRepeatableSpec<T>
}
